...
1. **Streams** 100,000 candidate profiles from a gzipped JSON Lines file
...
|-----------------|--------------------------|------------------------------------------|
| `--candidates`  | `candidates.jsonl.gz`    | Path to gzipped JSONL candidate dataset  |
...
├── candidates.jsonl.gz                  # Input dataset (not committed)
